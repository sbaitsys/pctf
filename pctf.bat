...
if "%opt1%" equ "y" (
    ...
    cd !worDir!
    tar.exe -a -c -f  "!worDir!\..\!zipName!" Signatures Templates Chrome Edge Firefox Wallpaper TaskbarPins WiFiProfiles Downloads Fonts .
    cd ..
    rmdir /s /q "!worDir!"
